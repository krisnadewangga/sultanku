...
class FormPage extends React.Component {
  ...
  handleSave = (toggle) => {
    axios.put("http://localhost:4000/api/update-penyakit/" + this.state.selectedData.id, {
  ...
  handleDelete = (toggle) => {
    axios.delete("http://localhost:4000/api/delete-penyakit/" + this.state.selectedData.id)
    .then(response => {
      toggle()
      axios.get(`http://localhost:4000/api/penyakit`)
      .then(res => this.setState({penyakit: res.data}))
  ...
  handleAdd = (toggle) => {
    if(this.state.name === ''){
      ...
      axios.post("http://localhost:4000/api/add-penyakit", {
            ...
            <Card>
              ...
              <CardBody>
                <Table innerRef={el => (this.tableRef = el)} responsive>
                  ...
                  <tfoot>
                    <Button color="primary" type='button' onClick={this.toggle('add')}>Tambah penyakit</Button>
                  </tfoot>
                </Table>
                ...
                <Modal
                  ...
                  <ModalBody>
                    <FormGroup>
                      <Label for="exampleEmail">Nama penyakit</Label>
                      <Input
                        type="text"
                        name="name"
                  ...
                  <ModalBody>
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        placeholder="ciri -ciri penyakit"
